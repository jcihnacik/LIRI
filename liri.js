...
const uCommand = process.argv[2];
const uParameter = process.argv[3];
...
function showThisMovie(uParameter) {
    ...
    var queryURL = "https://www.omdbapi.com/?t=" + queryMovie + "&y=&plot=short&apikey=trilogy";
    axios.get(queryURL).then(function (err, res, body) {
